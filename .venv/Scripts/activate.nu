...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\wlsgy\Desktop\final_project\Depth_Focusing\backend_django\.venv'
    let bin = 'Scripts'
    let path_sep = ';'
    ...
    let virtual_prompt = if ('kdt-final-django-py3.9' == '') {
        $'(char lparen)($virtual_env | path basename)(char rparen) '
    } else {
        '(kdt-final-django-py3.9) '
    }
...
alias deactivate = source 'C:\Users\wlsgy\Desktop\final_project\Depth_Focusing\backend_django\.venv\Scripts\deactivate.nu'
